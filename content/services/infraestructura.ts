export const infraestructuraServiceContent = {
  ...
  audit: {
    ...
    cta: { label: "Solicitar auditoría", href: "/cotizar?tab=servicios&tech=infraestructura&plan=auditoria-seo-pago-unico" },
  },
    ...
    cards: [
      {
        ...
        price: "Desde $2,900 (pago único) + IVA",
      },
      {
        ...
        price: "Desde $6,900 (pago único) + IVA",
      },
      {
        ...
        price: "Desde $12,900 (pago único) + IVA (Enterprise: a cotizar)",
      },
    ],
  },
