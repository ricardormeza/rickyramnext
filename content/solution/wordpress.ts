...
export const wordpressContent = {
  hero: {
    ...
    descriptions: [
      ...
      "Incluye hosting administrado + SSL el primer año para que tu negocio no batalle con lo tecnico.",
    ],
    bullets: [
      "Panel editable",
  ...
  addOns: {
    ...
    addOns: [
      "Tracking Lite (GA4 sin GTM, 1 conversion): Desde $1,500",
      "Tracking Standard (GA4 + GTM + 3-5 conversiones): Desde $3,500",
      "Ecommerce Tracking: Desde $12,900",
      "Auditoria SEO: Emprendedor $4,900 | PyME $12,900 | Empresa $29,900",
      "Google Ads Setup: Desde $6,900",
      "Meta Ads Setup: Desde $4,900",
      "TikTok Ads Setup: Desde $4,900",
      "Hardening inicial WordPress: Desde $3,900",
    ],
    recurring: [
      "Mantenimiento (updates + backups + uptime): Desde $1,490 / mes",
      "Monitoreo + hardening: Desde $1,900 / mes",
      "SEO mensual: Desde $6,900 / mes",
      "Gestión de campañas: Desde $6,900 / mes",
      "Analitica + reporting: Desde $2,900 / mes",
    ],
