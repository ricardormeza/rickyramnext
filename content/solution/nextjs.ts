...
export const nextjsContent = {
    ...
    table: [
      {
        ...
        scope: "1 página, 6 secciones, CTA y formulario",
        price: "Desde $12,900",
      },
      {
        name: "Sitio Básico (custom)",
        idealFor: "Servicios con UX premium",
        scope: "6-7 Páginas estáticas",
        price: "Desde $18,900",
      },
      {
        name: "PyME (custom)",
  ...
  scopes: {
    ...
    cards: [
      ...
      {
        title: "Sitio básico custom (alcance tipico)",
        bullets: [
          "6-7 Páginas (estática)",
          "1-2 Formularios",
          "1 Idioma",
  ...
  cta: {
    ...
    secondaryCta: { label: "Agendar llamada", href: "/Agendar-llamada" },
